...
describe('createExampleComponentCode', () => {
    ...
    test('should only disambiguate duplicate import names', async () => {
        ...
        expect(exampleCode).toContain("import CardWorkCardFramerComponent from './src/card/work-card'");
        expect(exampleCode).toContain("import CardsWorkCardFramerComponent from './src/cards/work-card'");
        expect(exampleCode).toContain("import FramerNavFramerComponent from './src/shared/nav/framer-nav'");
    });
}, 1000 * 10);
