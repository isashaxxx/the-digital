 ...
 */
export function validateShell(value) {
    if (value == null || value === '')
        return undefined;
 ...
 */
export function generateCompletionScript(shell, cliName, cliPath) {
 ...
 */
export async function installCompletions(cliName, cliPath, shell) {
    ...
    if (!targetShell) {
        throw new Error('Could not detect shell. Set the SHELL environment variable or pass --shell explicitly.');
    }
    ...
    throw new Error(`No writable ${targetShell} completion directory found.\n\nTried:\n${triedPaths}\n\n${hint}`);
}
/**
 ...
 */
export async function uninstallCompletions(cliName, shell) {
