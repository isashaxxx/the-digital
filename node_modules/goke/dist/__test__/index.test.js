...
describe('regression: oracle-found issues', () => {
    ...
    test('.help() then .required() throws because --help is a boolean flag', () => {
        ...
        expect(() => {
            ;
            cli.option('--url <url>', z.string().describe('URL')).help().required();
        }).toThrow('boolean flags cannot be required');
    });
...
describe('shared options via factory function', () => {
    test('factory function preserves type inference for shared + command-specific options', async () => {
        ...
        function analyticsCommand(name, description) {
            return cli
        ...
        await cli.parse('node bin pages -p my-app -p api --since 30d --limit 50 --domain example.com'.split(' '), { run: true });
        // Shared options
